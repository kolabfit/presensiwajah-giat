...
--
-- Host: localhost
-- Generation Time: Aug 05, 2026 at 04:00 AM
...
INSERT INTO `admin_config` (`id`, `admin_id`, `password`, `updated_at`) VALUES
(1, 'admin', 'giat123', '2026-08-04 11:51:30');
...
INSERT INTO `attendance` (`id`, `timestamp`, `date`, `name`, `location`, `shift`, `time_in`, `time_out`, `status`, `note`, `photo_cdn_id`, `gps_latitude`, `gps_longitude`, `check_in_photo_file_id`, `check_in_photo_url`, `check_in_latitude`, `check_in_longitude`, `check_out_photo_file_id`, `check_out_photo_url`, `check_out_latitude`, `check_out_longitude`, `check_in_location_id`, `check_in_accuracy`, `check_in_distance`, `check_out_location_id`, `check_out_accuracy`, `check_out_distance`) VALUES
...
INSERT INTO `employees` (`id`, `name`, `status`, `created_at`, `qr_code_data`, `photo_cdn_id`, `qr_code`, `photo_file_id`, `photo_url`, `qr_file_id`, `qr_url`, `face_registered`, `face_descriptor`) VALUES
...
INSERT INTO `locations` (`id`, `name`, `created_at`, `address`, `place_id`, `latitude`, `longitude`, `radius_meter`, `max_accuracy_meter`, `is_active`) VALUES
...
(4, 'ARTSHOP FIK', '2026-07-28 07:26:53', 'Danau Galau, Lengkong, Dayeuhkolot, Indonesia', NULL, -6.9720032, 107.6312995, 100, 50, 1),
(5, 'GIAT EXPRESS', '2026-07-28 07:27:06', 'Jalan Belakang Monumen Telkom, Lengkong, Dayeuhkolot, Indonesia', NULL, -6.9727416, 107.6330186, 100, 50, 1),
...
INSERT INTO `shifts` (`id`, `name`, `start_time`, `end_time`, `is_overtime`, `created_at`) VALUES
...
ALTER TABLE `attendance`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_date_name` (`date`,`name`);
